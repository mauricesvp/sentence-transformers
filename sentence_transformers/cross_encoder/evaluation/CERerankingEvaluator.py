...
class CERerankingEvaluator:
    ...
    def __init__(
        self, samples, mrr_at_k: int = 10, name: str = "", write_csv: bool = True
    ):
        ...
        self.csv_file = (
            "CERerankingEvaluator" + ("_" + name if name else "") + "_results.csv"
        )
    ...
    def __call__(
        ...
        for instance in self.samples:
            ...
            pred_scores = model.predict(
                model_input, convert_to_numpy=True, show_progress_bar=False
            )
